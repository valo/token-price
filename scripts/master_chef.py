...
def fetch_farm_info(
  ...
  lp_token_price = priceOfUniPair(interface.UniswapPair(stake_token), router_address)

  tvl = lp_token_price * stake_token.balanceOf(contract) / 10 ** stake_token.decimals()
